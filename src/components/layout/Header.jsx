...
const Header = () => {
 ...
 useEffect(() => {
  ...
  return (
    <>
    <header className="sticky top-0 z-50 bg-gray-50 backdrop-blur-sm border-b border-gray-200 shadow-sm">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          >
            <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-back" fill="white" viewBox="0 0 20 20">
          ...
          <button
            type="button"
            className="md:hidden inline-flex items-center justify-center p-2 rounded-md text-black bg-white"
            onClick={toggleNav}
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out bg-gray-50 ${
          isNavOpen 
